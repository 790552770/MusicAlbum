...
- (UIButton *)playBtn{
    if (!_playBtn) {
        ...
        [_playBtn setBackgroundImage:[UIImage imageNamed:@"toolbar_play_n_p.png"] forState:UIControlStateNormal];
        [_playBtn setBackgroundImage:[UIImage imageNamed:@"toolbar_pause_n_p.png"] forState:UIControlStateSelected];
